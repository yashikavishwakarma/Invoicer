...
export default function About() {
    return (
        <>
            <section className="bg-teal-200 lg:py-32 ">
                <div className="max-width">
                    <div className="overlay">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-center mb-3 text-slate-800 lg:mb-8">
                            About Invoicer
                        </h1>
                        <p className="text-slate-700 text-center text-2xl lg:w-2/3 lg:mx-auto">
                            Invoicer is an Invoicing application designed and built by MechaCode, whose main purpose is to - as the name suggests - create
                            and send invoices to clients, because this is something every entrepreneur
                            struggled with before. We hope it helps you as well.
                        </p>
